...
def nii2array_niba(Pathnii):
    img=nib.load(Pathnii)
    a = [-1 if img.affine[0,0]<0 else 1,-1 if img.affine[1,1]<0 else 1,-1 if img.affine[2,2]<0 else 1]
    spacing = np.array([img.affine[0,0],img.affine[1,1],img.affine[2,2]]) * a
